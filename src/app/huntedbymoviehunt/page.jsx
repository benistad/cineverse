  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="text-center mb-8">
        ...
        <SeoHeading level={1} className="text-3xl md:text-4xl font-bold mb-2">Hunted by MovieHunt</SeoHeading>
        <p className="text-xl text-gray-600 italic">Les Films Qu'il Ne Faut Surtout Pas Rater</p>
      </div>
      
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <SeoHeading level={2} className="text-2xl font-bold mb-4">🎯 Découvrez le Badge "Hunted"</SeoHeading>
        <p className="mb-4">
      ...
      <div className="bg-blue-50 rounded-lg shadow-md p-6 mb-8">
        <SeoHeading level={2} className="text-2xl font-bold mb-4">🔥 Qu'est-ce que le badge #HuntedbyMovieHunt ?</SeoHeading>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <SeoHeading level={2} className="text-2xl font-bold mb-4">🎬 Pourquoi ce badge ?</SeoHeading>
      ...
      <div className="bg-purple-50 rounded-lg shadow-md p-6 mb-8">
        <SeoHeading level={2} className="text-2xl font-bold mb-4">🔍 Où le trouver ?</SeoHeading>
        <p className="mb-4">
      ...
      <div className="bg-gray-100 rounded-lg shadow-md p-6 mb-8">
        <SeoHeading level={2} className="text-2xl font-bold mb-4">🧠 En résumé</SeoHeading>
